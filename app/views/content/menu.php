    ...
    <div class="topbar d-flex align-items-center">
      <div class="container d-flex justify-content-center justify-content-md-between">
        <div class="d-none d-md-flex align-items-center">
          <i class="bi bi-clock me-1"></i> Lunes - Sabado, 8AM a 10PM
        </div>
        <div class="d-flex align-items-center">
          <i class="bi bi-phone me-1"></i> Llamanos +503 6205 7666
        </div>
      </div>
    </div><!-- End Top Bar -->
          ...
          <ul>
            ...
            <li class="dropdown"><a href="#"><span>Dropdown</span> <i class="bi bi-chevron-down toggle-dropdown"></i></a>
              <ul>          
                ...
                <li class="dropdown"><a href="#"><span>Odontologos</span> <i class="bi bi-chevron-down toggle-dropdown"></i></a>
                  <ul>
                  <li><a href="#"
                id="btnNuevoOdontologo"
                data-bs-toggle="modal"
                data-bs-target="#modalOdontologo"
                title="Nuevo">Agregar Odontologo</a></li>

                <li><a href="#"
                id="btnVerOdontologo"
                data-bs-toggle="modal"
                data-bs-target="#modalOdontologoVer"
                title="Tabla Odontologo">Ver Odontologos</a></li>
      ...
      <div class="container">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-6 content" data-aos="fade-up" data-aos-delay="200">
            ...
            <p class="fst-italic">
              En [Nombre de tu Clínica Dental], nos especializamos en ofrecer tratamientos odontológicos de alta calidad para todas las edades. Nuestro equipo está conformado por odontólogos capacitados, 
              comprometidos con brindar un servicio cercano, seguro y personalizado.
            </p>
            <ul>
              <li><i class="bi bi-check2-all"></i> <span>Limpiezas, resinas, extracciones y tratamientos generales.</span></li>
              <li><i class="bi bi-check2-all"></i> <span>Radiografías digitales para diagnósticos precisos.</span></li>
              <li><i class="bi bi-check2-all"></i> <span>Especialistas en ortodoncia, endodoncia y estética dental.</span></li>
            </ul>
            <p>
              Nuestro compromiso es ofrecerte una atención dental integral en un ambiente cómodo y profesional. Queremos que cada visita sea una experiencia positiva y que disfrutes de una sonrisa sana, funcional y estética. 
              Estamos aquí para ayudarte a mantener tu salud bucal en su mejor estado.
            </p>
          </div>
        </div>
    ...
    <section id="features" class="features section">
      ...
      <div class="container">
        ...
        <div class="row justify-content-around gy-4">
          <div class="features-image col-lg-6" data-aos="fade-up" data-aos-delay="100"><img src="<?php echo APP_URL; ?>app/views/assets/img/features.jpg" alt=""></div>
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="swiper init-swiper">
          ...
          <div class="swiper-wrapper align-items-center">
            <div class="swiper-slide"><a class="glightbox" data-gallery="images-gallery" href="<?php echo APP_URL; ?>app/views/assets/img/gallery/gallery-1.jpg"><img src="<?php echo APP_URL; ?>app/views/assets/img/gallery/gallery-1.jpg" class="img-fluid" alt=""></a></div>
            <div class="swiper-slide"><a class="glightbox" data-gallery="images-gallery" href="<?php echo APP_URL; ?>app/views/assets/img/gallery/gallery-2.jpg"><img src="<?php echo APP_URL; ?>app/views/assets/img/gallery/gallery-2.jpg" class="img-fluid" alt=""></a></div>
            <div class="swiper-slide"><a class="glightbox" data-gallery="images-gallery" href="<?php echo APP_URL; ?>app/views/assets/img/gallery/gallery-3.jpg"><img src="<?php echo APP_URL; ?>app/views/assets/img/gallery/gallery-3.jpg" class="img-fluid" alt=""></a></div>
            <div class="swiper-slide"><a class="glightbox" data-gallery="images-gallery" href="<?php echo APP_URL; ?>app/views/assets/img/gallery/gallery-4.jpg"><img src="<?php echo APP_URL; ?>app/views/assets/img/gallery/gallery-4.jpg" class="img-fluid" alt=""></a></div>
            <div class="swiper-slide"><a class="glightbox" data-gallery="images-gallery" href="<?php echo APP_URL; ?>app/views/assets/img/gallery/gallery-5.jpg"><img src="<?php echo APP_URL; ?>app/views/assets/img/gallery/gallery-5.jpg" class="img-fluid" alt=""></a></div>
            <div class="swiper-slide"><a class="glightbox" data-gallery="images-gallery" href="<?php echo APP_URL; ?>app/views/assets/img/gallery/gallery-6.jpg"><img src="<?php echo APP_URL; ?>app/views/assets/img/gallery/gallery-6.jpg" class="img-fluid" alt=""></a></div>
            <div class="swiper-slide"><a class="glightbox" data-gallery="images-gallery" href="<?php echo APP_URL; ?>app/views/assets/img/gallery/gallery-7.jpg"><img src="<?php echo APP_URL; ?>app/views/assets/img/gallery/gallery-7.jpg" class="img-fluid" alt=""></a></div>
            <div class="swiper-slide"><a class="glightbox" data-gallery="images-gallery" href="<?php echo APP_URL; ?>app/views/assets/img/gallery/gallery-8.jpg"><img src="<?php echo APP_URL; ?>app/views/assets/img/gallery/gallery-8.jpg" class="img-fluid" alt=""></a></div>
          </div>
